                        ...
                        <Form className={classes.form}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <Autocomplete
                                        options={plans}
                                        getOptionLabel={(option) => `${option.name} - Atendentes: ${option.users} - WhatsApp: ${option.connections} - Filas: ${option.queues} - R$ ${option.amount}`}
                                        renderInput={(params) => (
                                            <TextField
                                                {...params}
                                        ...
                                        onChange={(event, value) => setFieldValue("planId", value?.id || "")}
                                    />
                                </Grid>
                            </Grid>
                            <Button
